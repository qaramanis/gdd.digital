...
export const GDD_SECTIONS: GDDSection[] = [
  {
    ...
    subSections: [
      ...
      },
      {
        ...
        instructions: `Define the target audience in 2-3 paragraphs. Include: 1) Primary age range and demographics, 2) Gaming experience level (casual, core, hardcore), 3) What other games they likely play (reference similar successful titles), 4) What appeals to them (competition, exploration, story, social features), 5) How they discover and purchase games. Be realistic and specific - avoid saying "everyone" as the target.`,
      },
      {
        id: "market_analysis",
        ...
        instructions: `Provide market analysis in 2-3 paragraphs covering: 1) The current state of the genre/market, 2) 2-3 key competitors and what they do well, 3) Gaps or opportunities in the market this game addresses, 4) How this game differentiates itself from competitors, 5) Why now is a good time for this game. Base analysis on the game's concept and target audience. Be analytical and strategic, not just promotional.`,
      },
    ],
  },
  {
    ...
    subSections: [
      {
        ...
        instructions: `Articulate the core concept in 2-3 paragraphs. Focus on: 1) The central "big idea" or fantasy the game delivers, 2) What makes this concept compelling and worth building a game around, 3) How the concept translates into actual gameplay, 4) The emotional or experiential goal for players. This should be the foundation everything else builds upon - clear, focused, and inspiring.`,
      },
      {
        id: "unique_selling_points",
        title: "Unique Selling Points",
        placeholder: "List 3-5 key features that make your game stand out from competitors...",
        instructions: `List and explain 3-5 unique selling points, each in its own paragraph. For each USP: 1) State the feature/aspect clearly, 2) Explain why it's unique or innovative, 3) Describe the player benefit, 4) Reference how it differs from competitors if relevant. These should be features that would appear in marketing materials - concrete, compelling, and differentiated.`,
      },
      {
        id: "genre_and_style",
        title: "Genre & Visual Style",
        placeholder: "Define the genre(s), sub-genres, visual aesthetic, and overall tone...",
        instructions: `Describe the genre and style in 2-3 paragraphs covering: 1) Primary and secondary genres, 2) Visual art style (realistic, stylized, pixel art, etc.) with specific references if helpful, 3) Overall tone and mood (dark, whimsical, intense, relaxing), 4) Audio style and atmosphere, 5) How these elements support the core concept. Be specific enough that an artist or designer could understand the vision.`,
      },
      {
        id: "player_experience",
        title: "Player Experience Goals",
        placeholder: "What emotions and experiences do you want players to have?",
        instructions: `Define the target player experience in 2-3 paragraphs. Cover: 1) The primary emotions you want players to feel (excitement, curiosity, satisfaction, fear, etc.), 2) The type of moments you want to create (triumphant victories, tense standoffs, peaceful exploration), 3) How players should feel after a play session, 4) The "fantasy" players are living out. Focus on feelings and experiences, not mechanics.`,
      },
    ],
  },
  {
    ...
    subSections: [
      {
        ...
        instructions: `Outline the project timeline in 2-3 paragraphs covering: 1) Overall development duration estimate, 2) Major phases and their duration, 3) Key milestones and deliverables, 4) Dependencies and critical path, 5) Buffer and contingency approach. Be realistic about timing without specific dates.`,
      },
      {
        id: "team_structure",
        title: "Team Structure",
        placeholder: "Team roles, responsibilities, and resource allocation...",
        instructions: `Describe team structure in 2-3 paragraphs covering: 1) Core team roles and responsibilities, 2) Team size at different project phases, 3) Internal vs. outsourced work, 4) Leadership and decision-making structure, 5) Collaboration and communication approach. Show how the team is organized to deliver.`,
      },
      {
        id: "development_phases",
        title: "Development Phases",
        placeholder: "Pre-production, production, alpha, beta, launch phases...",
        instructions: `Detail development phases in 2-3 paragraphs covering: 1) Pre-production goals and deliverables, 2) Production milestones and focus areas, 3) Alpha and beta definitions and goals, 4) Polish and launch preparation, 5) Post-launch support phase. Define what success looks like at each phase.`,
      },
      {
        id: "risk_assessment",
        title: "Risk Assessment",
        placeholder: "Potential risks, mitigation strategies, contingency plans...",
        instructions: `Assess risks in 2-3 paragraphs covering: 1) Technical risks and mitigation, 2) Scope and schedule risks, 3) Team and resource risks, 4) Market and competitive risks, 5) Contingency plans for major risks. Be honest about challenges and prepared with solutions.`,
      },
    ],
  },
  {
    ...
    subSections: [
      {
        ...
        instructions: `Address IP concerns in 2-3 paragraphs covering: 1) Original IP vs. licensed content, 2) Trademark considerations for game name and branding, 3) Third-party assets and licensing needs, 4) IP protection strategy, 5) Any licensing revenue opportunities. Ensure the project is legally sound.`,
      },
      {
        id: "age_ratings",
        title: "Age Ratings",
        placeholder: "ESRB, PEGI, and other regional rating considerations...",
        instructions: `Describe rating expectations in 2-3 paragraphs covering: 1) Target age rating and content considerations, 2) Content that may affect ratings (violence, language, etc.), 3) Regional rating boards to target (ESRB, PEGI, etc.), 4) Any content modifications for different regions, 5) Rating impact on marketing and distribution.`,
      },
      {
        id: "privacy_and_data",
        title: "Privacy & Data",
        placeholder: "GDPR, COPPA, data collection, privacy policies...",
        instructions: `Address privacy requirements in 2-3 paragraphs covering: 1) Data collection plans and purposes, 2) GDPR compliance approach, 3) COPPA considerations (if targeting under 13), 4) Privacy policy requirements, 5) Data security measures. Ensure responsible data handling.`,
      },
      {
        id: "platform_compliance",
        title: "Platform Compliance",
        placeholder: "Store requirements, certification processes, guidelines...",
        instructions: `Describe platform compliance in 2-3 paragraphs covering: 1) Target platform store requirements (Steam, PlayStation, Xbox, Nintendo, App Stores), 2) Certification process understanding, 3) Platform-specific content guidelines, 4) Technical requirements for certification, 5) Timeline for certification in project plan.`,
      },
    ],
  },
];
