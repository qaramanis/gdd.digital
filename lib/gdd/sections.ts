    ...
    subSections: [
      {
        ...
        placeholder: "Describe the history and events that set the stage for your game - what happened before the player arrives...",
      ...
      },
      {
        ...
        placeholder: "Describe the game world's environment, mood, tone, and the feeling it evokes...",
      ...
      },
      {
        ...
        placeholder: "Introduce the key characters - who they are, what they want, and why they matter to the story...",
      ...
      },
      {
        ...
        placeholder: "Explain how characters grow and change throughout the story - their transformations and lessons learned...",
      ...
      },
      {
        ...
        placeholder: "Define the main conflict driving the narrative - what forces oppose each other and what's at stake...",
      ...
      },
      {
        ...
        placeholder: "Identify the deeper meanings, recurring symbols, and philosophical questions your story explores...",
      ...
      },
      {
        ...
        placeholder: "Outline the major story beats - inciting incident, rising action, climax, and resolution...",
      ...
      },
      {
        ...
        placeholder: "Describe player-driven narrative choices - how decisions affect the story, relationships, and endings...",
      ...
      },
      {
        ...
        placeholder: "Explain how the story is told - cutscenes, dialogue, environmental storytelling, found documents...",
    ...
    subSections: [
      {
        ...
        placeholder: "Describe the fundamental gameplay mechanics - the primary actions and systems players interact with...",
      ...
      },
      {
        id: "controls",
        title: "Controls",
        placeholder: "Define the control schemes - how players physically interact with the game across different platforms...",
      ...
      },
      {
        ...
        placeholder: "Explain how players grow and advance - leveling, unlocks, skill trees, upgrades...",
      ...
      },
      {
        ...
        placeholder: "Describe how challenges are structured - difficulty curves, obstacles, skill tests, and learning...",
      ...
      },
      {
        id: "balancing",
        title: "Balancing",
        placeholder: "Explain the approach to game balance - difficulty options, power curves, fair play...",
      ...
      },
      {
        ...
        placeholder: "Describe how the game communicates with players - visual, audio, and haptic feedback systems...",
      ...
      },
      {
        ...
        placeholder: "Describe unscripted gameplay possibilities - system interactions, player creativity, unexpected strategies...",
      ...
      },
      {
        id: "game_modes",
        title: "Game Modes",
        placeholder: "List and describe available game modes - campaign, multiplayer, challenges, custom modes...",
    ...
    subSections: [
      {
        ...
        placeholder: "Describe the different levels, stages, or areas in your game - their themes, settings, and purpose...",
      ...
      },
      {
        ...
        placeholder: "Detail level objectives, physical layouts, obstacles players face, and challenges to overcome...",
      ...
      },
      {
        ...
        placeholder: "Explain how difficulty increases across levels - pacing, skill introduction, challenge escalation...",
      ...
      },
      {
        ...
        placeholder: "Describe enemy positioning strategy and AI behaviors - patrol patterns, aggression, tactics...",
      ...
      },
      {
        ...
        placeholder: "Describe hidden content - secret areas, collectible items, references, and rewards for exploration...",
    ...
    subSections: [
      {
        ...
        placeholder: "Define the overall visual style, artistic vision, and direction for the game...",
      ...
      },
      {
        ...
        placeholder: "Describe character designs, environment art, and 3D/2D model requirements...",
      ...
      },
      {
        ...
        placeholder: "List graphical assets - textures, sprites, effects, animations...",
      ...
      },
      {
        id: "audio_assets",
        title: "Audio Assets",
        placeholder: "Define music, sound effects, voice acting, and ambient audio needs...",
      ...
      },
      {
        id: "ui_ux_assets",
        title: "UI/UX Assets",
        placeholder: "List user interface elements - buttons, icons, menus, HUD components...",
      ...
      },
      {
        id: "concept_art",
        title: "Concept Art",
        placeholder: "Describe concept art needs - characters, environments, props, key scenes...",
      ...
      },
      {
        ...
        placeholder: "Explain the workflow for creating assets - from concept to implementation...",
      ...
      },
      {
        ...
        placeholder: "Define how assets are organized, versioned, and stored...",
      ...
      },
      {
        ...
        placeholder: "List third-party assets, licensed content, and external asset sources...",
      ...
      },
      {
        ...
        placeholder: "Define assets needed for localization - translated text, regional audio, cultural adaptations...",
      ...
      },
      {
        ...
        placeholder: "List assets for testing - debug tools, test builds, QA documentation...",
      ...
      },
      {
        id: "storyboarding",
        title: "Storyboarding",
        placeholder: "Describe storyboard needs - cutscenes, key moments, narrative sequences...",
      ...
      },
      {
        id: "mood_boards",
        title: "Mood Boards",
        placeholder: "Define mood boards - visual references, tone inspiration, aesthetic guides...",
    ...
    subSections: [
      {
        ...
        placeholder: "Define target platforms, hardware requirements, and core technologies used...",
      ...
      },
      {
        id: "engine_choice",
        title: "Engine Choice",
        placeholder: "Describe the game engine selection, rationale, and key engine features utilized...",
      ...
      },
      {
        ...
        placeholder: "Define online features, multiplayer modes, server architecture, and connectivity needs...",
      ...
      },
      {
        ...
        placeholder: "Define performance targets, optimization strategies, and resource management...",
      ...
      },
      {
        ...
        placeholder: "List tools for debugging, profiling, testing, and quality assurance...",
      ...
      },
      {
        ...
        placeholder: "Define input systems, controller support, and platform-specific input handling...",
    ...
    subSections: [
      {
        id: "main_menu",
        title: "Main Menu",
        placeholder: "Describe the main menu structure, options, and visual presentation...",
      ...
      },
      {
        id: "in_game_huds",
        title: "In-Game HUDs",
        placeholder: "Define the heads-up display elements - health, ammo, objectives, status indicators...",
      ...
      },
      {
        ...
        placeholder: "Describe inventory systems, equipment screens, item management interfaces...",
      ...
      },
      {
        ...
        placeholder: "Define dialogue boxes, NPC interactions, choice prompts, and contextual actions...",
      ...
      },
      {
        ...
        placeholder: "Describe map screens, minimaps, waypoints, and navigation aids...",
      ...
      },
      {
        ...
        placeholder: "Define settings categories - graphics, audio, controls, gameplay options...",
      ...
      },
      {
        ...
        placeholder: "Describe loading screen design, progress bars, tips, and transition screens...",
      ...
      },
      {
        id: "help_feature",
        title: "Help Feature",
        placeholder: "Define in-game help systems - tutorials, tooltips, guides, control references...",
      ...
      },
      {
        ...
        placeholder: "Define accessibility options - colorblind modes, subtitles, control remapping, assists...",
    ...
    subSections: [
      {
        ...
        placeholder: "Define the core revenue model - premium, F2P, subscription, hybrid...",
      ...
      },
      {
        ...
        placeholder: "Design in-game currencies, earning rates, spending sinks, and economic balance...",
      ...
      },
      {
        ...
        placeholder: "Define store structure, item categories, pricing tiers, and purchase flow...",
      ...
      },
      {
        ...
        placeholder: "Plan ad placements, formats, frequency, and opt-in rewards...",
      ...
      },
      {
        ...
        placeholder: "Design systems to keep players engaged - daily rewards, events, battle passes...",
      ...
      },
      {
        ...
        placeholder: "Address legal requirements - loot box disclosures, age ratings, regional regulations...",
    ...
    subSections: [
      {
        ...
        placeholder: "Define your primary and secondary audiences - age, interests, gaming habits, platforms...",
      ...
      },
      {
        ...
        placeholder: "Define the game's brand - visual identity, tone of voice, key messages, positioning...",
      ...
      },
      {
        ...
        placeholder: "Set measurable marketing goals - awareness, wishlists, conversions, engagement targets...",
      ...
      },
      {
        ...
        placeholder: "Plan PR activities - press outreach, media coverage, influencer partnerships, events...",
      ...
      },
      {
        ...
        placeholder: "Plan community building - Discord, social media, forums, player feedback loops...",
      ...
      },
      {
        ...
        placeholder: "Plan the launch - pre-launch activities, launch day, promotional campaigns, partnerships...",
      ...
      },
      {
        ...
        placeholder: "Plan ongoing support - content updates, patches, DLC roadmap, community communication...",
    ...
    subSections: [
      {
        ...
        placeholder: "Summarize the project scope, goals, team size, and overall development approach...",
      ...
      },
      {
        ...
        placeholder: "Define the overall timeline, major milestones, and key deliverable dates...",
      ...
      },
      {
        ...
        placeholder: "Describe pre-production activities - prototyping, documentation, concept validation...",
      ...
      },
      {
        ...
        placeholder: "Describe the main production phase - asset creation, feature development, integration...",
      ...
      },
      {
        ...
        placeholder: "Plan alpha and beta phases - testing scope, participant selection, feedback integration...",
      ...
      },
      {
        ...
        placeholder: "Plan the polish phase - bug fixing, performance optimization, final tuning...",
      ...
      },
      {
        ...
        placeholder: "Plan post-launch activities - patches, updates, community support, content roadmap...",
      ...
      },
      {
        ...
        placeholder: "Identify project risks and mitigation strategies - technical, schedule, resource risks...",
      ...
      },
      {
        ...
        placeholder: "Plan resource distribution and budget - team allocation, outsourcing, financial tracking...",
    ...
    subSections: [
      {
        ...
        placeholder: "Define IP ownership, trademarks, copyrights, patents, and licensing agreements...",
      ...
      },
      {
        ...
        placeholder: "Plan data collection, storage, privacy policies, and compliance with GDPR, COPPA...",
      ...
      },
      {
        ...
        placeholder: "Plan for ESRB, PEGI, and other regional ratings - content considerations and target ratings...",
      ...
      },
      {
        ...
        placeholder: "Define user agreements, license terms, liability limitations, and dispute resolution...",
      ...
      },
      {
        ...
        placeholder: "Address platform requirements, accessibility laws, consumer protection, and industry guidelines...",
